...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-md-6">
		<div class="btn-group">
    <button type="button" class="btn btn-site">Contact</button>
    <button type="button" class="btn btn-site">About us</button>
    <button type="button" class="btn btn-site">Privacy Policy</button>
    <button type="button" class="btn btn-site">Terms and Conditions</button>
    <button type="button" class="btn btn-site">Rss</button>
    <button type="button" class="btn btn-site">Sitempas</button>
  </div>
		</div>
	 </div>
</div>
